...
robocopy "$RayBin" "..\Raylib-CsLo\" raylib.dll
...
robocopy "$RayBin" "..\Raylib-CsLo\" raygui.dll
" ################ # physac"
dotnet ..\sub-modules\ClangSharp\artifacts\bin\sources\ClangSharpPInvokeGenerator\Release\net6.0\ClangSharpPInvokeGenerator.dll @gen-raylib.rsp --file-directory "$RaylibExtrasSrc" --include-directory ../sub-modules/raylib/src/ --file physac.h --methodClassName Physac --libraryPath physac.dll
" ################ # Easings "
