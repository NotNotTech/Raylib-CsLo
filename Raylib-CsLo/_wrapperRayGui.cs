...
public static unsafe partial class RayGui
{
	...
	public static void GuiGroupBox(Rectangle bounds, string text) { using var sotext = text.MarshalUtf8(); GuiGroupBox(bounds, sotext.AsPtr()); }


	public static void GuiLine(Rectangle bounds, string text) { using var sotext = text.MarshalUtf8(); GuiLine(bounds, sotext.AsPtr()); }

	public static void GuiLabel(Rectangle bounds, string text) { using var sotext = text.MarshalUtf8(); GuiLabel(bounds, sotext.AsPtr()); }


	public static Boolean GuiButton(Rectangle bounds, string text) { using var sotext = text.MarshalUtf8(); return GuiButton(bounds, sotext.AsPtr()); }


	public static Boolean GuiLabelButton(Rectangle bounds, string text) { using var sotext = text.MarshalUtf8(); return GuiLabelButton(bounds, sotext.AsPtr()); }


	public static Boolean GuiToggle(Rectangle bounds, string text, Boolean active) { using var sotext = text.MarshalUtf8(); return GuiToggle(bounds, sotext.AsPtr(), active); }


	public static int GuiToggleGroup(Rectangle bounds, string text, int active) { using var sotext = text.MarshalUtf8(); return GuiToggleGroup(bounds, sotext.AsPtr(), active); }


	public static Boolean GuiCheckBox(Rectangle bounds, string text, Boolean @checked) { using var sotext = text.MarshalUtf8(); return GuiCheckBox(bounds, sotext.AsPtr(), @checked); }


	public static int GuiComboBox(Rectangle bounds, string text, int active) { using var sotext = text.MarshalUtf8(); return GuiComboBox(bounds, sotext.AsPtr(), active); }


	public static Boolean GuiDropdownBox(Rectangle bounds, string text, int* active, Boolean editMode) { using var sotext = text.MarshalUtf8(); return GuiDropdownBox(bounds, sotext.AsPtr(), active, editMode); }


	public static Boolean GuiSpinner(Rectangle bounds, string text, int* value, int minValue, int maxValue, Boolean editMode) { using var sotext = text.MarshalUtf8(); return GuiSpinner(bounds, sotext.AsPtr(), value, minValue, maxValue, editMode); }
	...
	public static void GuiStatusBar(Rectangle bounds, string text) { using var sotext = text.MarshalUtf8();
		GuiStatusBar(bounds, sotext.AsPtr()); }


	public static void GuiDummyRec(Rectangle bounds, string text) { using var sotext = text.MarshalUtf8();
	...
	public static int GuiListView(Rectangle bounds, string text, int* scrollIndex, int active) { using var sotext = text.MarshalUtf8();
