...
namespace Raylib_CsLo
{
    public static partial class Easings
    {
        ...
        {
            return (-c * MathF.Cos(t / d * (3.14159265358979323846f / 2.0f)) + c + b);
        }

        public static float EaseSineOut(float t, float b, float c, float d)
        {
            return (c * MathF.Sin(t / d * (3.14159265358979323846f / 2.0f)) + b);
        }

        public static float EaseSineInOut(float t, float b, float c, float d)
        {
            return (-c / 2.0f * (MathF.Cos(3.14159265358979323846f * t / d) - 1.0f) + b);
        }
        ...
        public static float EaseElasticIn(float t, float b, float c, float d)
        {
            ...
            return (-(postFix * MathF.Sin((t * d - s) * (2.0f * 3.14159265358979323846f) / p)) + b);
        }
