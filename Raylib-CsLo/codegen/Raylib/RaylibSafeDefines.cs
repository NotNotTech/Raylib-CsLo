...
public unsafe partial class RaylibS
{
    ...
    // MACRO RlRealloc(ptr,sz) realloc(ptr,sz)

    // MACRO RlFree(ptr) free(ptr)
    ...
    // UNKNOWN MouseRightButton MOUSE_BUTTON_RIGHT

    // UNKNOWN MouseMiddleButton MOUSE_BUTTON_MIDDLE

    // UNKNOWN MaterialMapDiffuse MATERIAL_MAP_ALBEDO

    // UNKNOWN MaterialMapSpecular MATERIAL_MAP_METALNESS

    // UNKNOWN ShaderLocMapDiffuse SHADER_LOC_MAP_ALBEDO

    // UNKNOWN ShaderLocMapSpecular SHADER_LOC_MAP_METALNESS
