...
public static class QuatConversion
{
    ...
    public static void Example()
    {
        ...
        while (!WindowShouldClose())    // Detect window close button or ESC key
        {
            ...
            DrawText(string.Format("{0}", v1.X.ToString("00.000")), 20, 20, 20, (v1.X == v2.X) ? Green : Black);
            DrawText(string.Format("{0}", v1.Y.ToString("00.000")), 20, 40, 20, (v1.Y == v2.Y) ? Green : Black);
            DrawText(string.Format("{0}", v1.Z.ToString("00.000")), 20, 60, 20, (v1.Z == v2.Z) ? Green : Black);

            DrawText(string.Format("{0}", v2.X.ToString("00.000")), 200, 20, 20, (v1.X == v2.X) ? Green : Black);
            DrawText(string.Format("{0}", v2.Y.ToString("00.000")), 200, 40, 20, (v1.Y == v2.Y) ? Green : Black);
            DrawText(string.Format("{0}", v2.Z.ToString("00.000")), 200, 60, 20, (v1.Z == v2.Z) ? Green : Black);
